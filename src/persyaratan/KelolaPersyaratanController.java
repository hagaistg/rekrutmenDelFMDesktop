 ...
 * @author Sondang;
 */
public class KelolaPersyaratanController implements Initializable {
...
//            q.setParameter("tgl", tglMasuk.getText());
    ...
    private void detailAction(ActionEvent event) throws IOException {
         AnchorPane paness = FXMLLoader.load(getClass().getResource("/persyaratan/DetailDaftarSyarat.fxml"));
            panes.getChildren().setAll(paness);
    }
