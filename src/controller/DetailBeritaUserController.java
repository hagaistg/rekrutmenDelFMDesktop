 ...
 * @author Hagai Stg
 */
public class DetailBeritaUserController implements Initializable {
@FXML
    ...
    public void addData(){
        this.id2 = KelolaBeritaUserController.id2;
        this.judul2 = KelolaBeritaUserController.judul2;
        this.topik2 = KelolaBeritaUserController.topik2;
        this.tanggal2 = KelolaBeritaUserController.tanggal2;
        this.deskripsi2 = KelolaBeritaUserController.deskripsi2;
